...
window.updatePrintPreview = function () {
    try {
        ...
        // ==================== الفوتر الجديد ====================
        // الفوتر خارج الجدول (بعد </table>) بحيث يظهر مرة واحدة فقط في آخر صفحة.
        // الفوتر في صف واحد بأربعة أعمدة.
        // ملاحظة: الكود القديم (داخل tfoot) موجود في دالة buildPrintFooterOldComment للرجوع إليه.
        const footerNewHtml = buildPrintFooterNew(fontSize, cellPadding);
        ...
        */
        ...
        <div class="print-footer-new" style="width:100%;margin-top:10px;page-break-inside:avoid;">
            <table style="width:100%;border-collapse:collapse;font-size:${fontSize};">
                <tr>
                    <td style="padding:${cellPadding};text-align:center;border:1px solid #000;font-weight:bold;width:25%;">رئيس قسم الموارد البشرية</td>
                    <td style="padding:${cellPadding};text-align:center;border:1px solid #000;font-weight:bold;width:25%;">رئيس قسم الحسابات</td>
                    <td style="padding:${cellPadding};text-align:center;border:1px solid #000;font-weight:bold;width:25%;">المراجعة</td>
                    <td style="padding:${cellPadding};text-align:center;border:1px solid #000;font-weight:bold;width:25%;">نائب المدير العام للشؤون المالية والإدارية</td>
                </tr>
            </table>
        </div>`;
        const finalHtmlWithFooter = finalHtml + footerNewHtml;
...
function enableColumnToggleForTable(table, tableKey) {
    ...
    headers.forEach((header, idx) => {
        ...
        // إضافة footerNewHtmlالزر قبل نص العنوان
        header.insertBefore(eyeBtn, header.firstChild);
